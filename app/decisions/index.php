	...
	function execute(){
		...
		switch ($action){
			case "get":
				...
				$name = $r["name"];
				echo "<table>";
				echo "<tr class='decision_name'><td>Name: </td><td><input name='name' value='$name'/></td></tr>";
				...
				echo "<tr class='decision_input_type'><td>Input type: </td><td><select class='decision_input_type'><option value='DropDown'>DropDown</option><option value='Text'>Text</option></select></td></tr>";
